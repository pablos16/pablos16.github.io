export default class Item extends Phaser.GameObjects.Image
{
    ...
    changeTo(ID)
    {
        let itemData = this._setItemData(ID);
    ...
    _setItemData(ID)
    {
        ...
        switch(ID)
        {
            ...
            case 1: name = 'Dinamita'; desc = 'Estos explosivos son más potentes de lo que parece...'; texture = 'Item_TNT';
                break;
            case 2: name = 'Alfombra barata'; desc = 'Luce con pelusillas. Parece desgastada, pero servirá.'; texture = 'Item_CheapCarpet';
                break;
            case 3: name = 'Alfombra persa'; desc = 'Preciada alfombra con muchos estampados. Su calidad es notable, aunque cuesta más de lo que debería...'; texture = 'Item_ExpensiveCarpet';
                break;
            ...
            case 10: name = 'Cerillas y aceite'; desc = 'Permiten prender fuego a prácticamente todo.'; texture = 'Item_OilAndMatches';
                break;
            case 11: name = 'Bolsa de dinero'; desc = 'Gran bolsa llena de dinero.'; texture = 'Item_CoinBag';
                break;
            case 12: name = 'Monedas'; desc = 'Unas pocas monedas.'; texture = 'Item_Coins';
                break;
            case 13: name = 'Carta'; desc = 'Es de mala educación abrirla si no es para ti. ¿Qué pondrá dentro?'; texture = 'Item_Message';
                break;
            // Objetos misceláneos:
            case 14: name = 'Diario de Paca'; desc = 'Contiene toda la dura vida de Paca.'; texture = 'Item_Diary';
                break;
            case 15: name = 'Fotografía de Leandro Gado'; desc = 'Se le ve muy feliz. ¿Quién es su amigo? No le has visto en toda la ciudad.'; texture = 'Item_Photo';
                break;
